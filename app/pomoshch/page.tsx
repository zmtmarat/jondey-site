...
const GROUPS: Group[] = [
  {
    ...
    items: [
      {
        q: 'Что такое Jondey?',
        a: 'Jondey — приложение, где в одном месте можно вызвать мастера, заказать доставку или грузоперевозку, вызвать спецтехнику и получить от магазинов цены на нужную запчасть. Вы описываете задачу — исполнители сами предлагают цену.',
      },
      {
