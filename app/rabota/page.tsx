...
export const metadata: Metadata = {
  ...
  description:
    'Ищете работу или подработку? Сантехник, электрик, автомеханик, мастер по ремонту техники, оператор спецтехники и другие. Свободный график, оплата напрямую, без вложений. Регистрация бесплатная — заказы сами найдут вас.',
