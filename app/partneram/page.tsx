  ...
  return (
    <main>
      ...
      >
        <DocSection id="who" n={1} title="Кому подходит">
          <DocList
            items={[
              ...
              'Владельцам спецтехники: эвакуаторы, автокраны, автовышки, экскаваторы, манипуляторы.',
        ...
        <DocSection id="fleet" n={4} title="Спецтехника">
          <DocList
            items={[
              'Размещайте автовышки, автокраны, эвакуаторы, экскаваторы, манипуляторы, погрузчики.',
