...
export const metadata: Metadata = {
  ...
  description:
    'Опишите задачу и назовите свою цену — мастера Jondey по всему Казахстану откликнутся сами. Ремонт, сантехника, электрика, клининг, запчасти, спецтехника. Без обзвона объявлений.',
